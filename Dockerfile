...
RUN apt-get update && \
    apt-get install -y ca-certificates curl php7.0 libapache2-mod-php7.0 php7.0-xsl php7.0-xml php7.0-zip php7.0-gd php7.0-pdo php7.0-opcache php7.0-mysql php7.0-curl php7.0-cli php7.0-intl msmtp-mta && \ 
